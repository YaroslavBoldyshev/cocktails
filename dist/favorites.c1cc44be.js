...
})({"katu2":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "2736d134c1cc44be";
...
},{}],"85dXi":[function(require,module,exports) {
...
var _favIngredientsMarkup = require("./favIngredientsMarkup");
...
function handleSubmit(e) {
    ...
    (0, _refsDefault.default).favCocktailsList.innerHTML = "";
    (0, _refsDefault.default).favIngredientsList.innerHTML = "";
    let serchResult;
    if (page == "cocktails") {
        const cocktailsStorege = localStorage.getItem("cocktails");
        arr = JSON.parse(cocktailsStorege);
        serchResult = arr.filter((el)=>el.strDrink.includes(e.currentTarget.elements.searchInput.value));
        res = serchResult;
        console.log(serchResult);
    } else if (page == "ingredients") {
        const cocktailsStorege = localStorage.getItem("ingredients");
        arr = JSON.parse(cocktailsStorege);
        serchResult = arr.filter((el)=>el.strIngredient.includes(e.currentTarget.elements.searchInput.value));
        res = serchResult;
        console.log(serchResult);
    }
    // ===============err/res============
    if (serchResult.length == 0) {
        if (page == "cocktails") (0, _refsDefault.default).favCocktailsErr.classList.remove("visually-hidden");
        else (0, _refsDefault.default).favIngredientsErr.classList.remove("visually-hidden");
    } else {
        if (page == "cocktails") (0, _refsDefault.default).favCocktailsErr.classList.add("visually-hidden");
        else (0, _refsDefault.default).favIngredientsErr.classList.add("visually-hidden");
        if (page == "cocktails") showSearchResults(serchResult);
        else showsearchedIngredients(serchResult);
    }
}
function showSearchResults(serchResult) {
    serchResult.map((el, index)=>{
        (0, _refsDefault.default).favCocktailsList.insertAdjacentHTML("beforeend", (0, _cocktailMarkupDefault.default)(el));
        // ------- adding icon----
...
},{"./refs":"2SdoY","./cocktailMarkup":"jAKy1","./plagination":"gvhGl","./learnMoreBtns":"dXxCJ","./favIngredientsMarkup":"ePWWG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./storage":"61jHw","./ingredientModalMarkup":"if63o","./fetchDrinks":"fYJqY"}]},["katu2","85dXi"], "85dXi", "parcelRequire58cb")

//# sourceMappingURL=favorites.c1cc44be.js.map
